...
void FORTRAN(allocation,(ITG *nload_,ITG *nforc_,ITG *nboun_,
	     ...
	     ITG *iuel,ITG *iprestr,ITG *nstam,ITG *ndamp,ITG *nmpmat_,ITG *phase_inf));
...
void readxstateini ( double *, int, int, int, int ) ;
void plasticwork (  char *, 
		    double *, int *, 
		   double *, double *,
		   double *, // pwork
		   double *, int *, // shcon nshcon
                   double *, int *, double *, //rhcon, nrhcon, t1
		   double *, double *, 
		   double *, // vini
                   int *, int *, char *, int *, 
		   double *, int *,
		   ...
		   double *, int *, int *,
		   int *, double *, double * ) ;
double interpolate_mat ( double *, int, int,
			 int *, int, 
			 double, int) ;
void itinerate_print ( int, int *, char**, 
		       int, double *, char** );
void random_print ( int, int *, char**, 
		    int, double *, char**, int );



void drxc ( double *, int *, double *, int *, int *,
            double *, double *, double *, int *, int *, int * ) ;
int istate_to_index ( int, int, int, int, int, int ) ;


void FORTRAN(calcvol, (int *ie0, int *nip, char * lakon,
                       ITG * kon, double * co, ITG * ipkon, double * ptr_volume ) ) ;
void FORTRAN ( calcvol2, (int *ie0, int *nip, char * lakon,
		          ITG * kon, double * co, ITG * ipkon, double * ptr_volume ) ) ;
void output_mtx ( double *ad, double *au, double *adb, double *aub, double *rhs,
		  int *neq, int *nzs, int *icol, int *irow, int *symmetryflag,
		  int solstatus, int iinc, int iit  ) ;
...
void arpack(double *co,ITG *nk,ITG **konp,ITG **ipkonp,char **lakonp,
         ...
         char *orname,double *mpcon, ITG *nmpcon,ITG *nmpmat_,
         double *pphase,double *cphase,double *phaseother,
         ITG *nphase,ITG *phase_inf);
...
void arpackbu(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     double *prop,char *orname,double *mpcon,ITG *nmpcon,
	     ITG *nmpmat_, double *pphase,double *cphase,double *phaseother,
             ITG *nphase,ITG *phase_inf);
...
void FORTRAN(calcmatwavspeed,(ITG *ne0,double *elcon,ITG *nelcon,
	    ...
	    double *xmatwavespeed,ITG *nmat,ITG *ipkon,double *xstate,
	    ITG *nstate_,double *mpcon, ITG *nmpcon,ITG *nmpmat_));
...
void calcresidual_h(ITG *nmethod,ITG *neq,double *b,double *fext,double *f,
        ITG *iexpl,ITG *nactdof,double *aux2,double *vold,
        double *vini,double *dtime,double *accold,ITG *nk,double *adb,
        double *aub,ITG *icol,ITG *irow,ITG *nzl,double *alpha,
	double *fextini,double *fini,ITG *islavnode,ITG *nslavnode,
        ...
        double *f_cm,double *f_cs,ITG *mi,ITG *nzs,ITG *nasym,
	ITG *idamping,double *veold,double *adc,double *auc,double *cvini,
        double *cv,double *enthaold, double *enthaini, ITG ienthabased, double *adl);
...
void FORTRAN(calinput,(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *stam,double *dacon,double *mpcon,ITG *nmpcon,
	       ITG *nmpmat_,double *pphase,double *cphase,double *phaseother,
               ITG *nphase,ITG *phase_inf,ITG *nflcon,double *flcon,
               double *lh, double *enthactrl, ITG *ipairmat, double *rdpcon,double *gscon));
...
void castfem(double **cop,ITG *nk,ITG **ipkonp,ITG **konp,char **lakonp,
    ...
    ITG *nflcon,double *flcon,double *lh,ITG *nmat);

void castfvm(double **co,ITG *nk,ITG **konp,ITG **ipkonp,char **lakonp,
	     ITG *ne,
	     ITG *nodeboun,ITG *ndirboun,double *xboun,ITG *nboun,
	     ...
	     ITG *network,char *orname,double *mpcon, ITG *nmpcon,
	     ITG *nmpmat_,double *pphase,double *cphase,double *phaseother,
             ITG *nphase,ITG *phase_inf,double *flcon,ITG *nflcon,double *lh,
	     double *rdpcon,double *gscon);
...
void FORTRAN(damagecal,(ITG *nea,ITG *neb,char *lakon,ITG *ipkon,ITG *mi,
            ITG *list,ITG *ilist,double *pressx,double *pressn,double *stx,
	    double *co,ITG *kon,double *xstate,ITG *nstate_,double *dtime,
            ITG *inum,ITG *nk,ITG *ne,double *orab,ITG *ielorien,double *vold,
...
void dyna(double **cop,ITG *nk,ITG **konp,ITG **ipkonp,char **lakonp,ITG *ne,
          ...
          char *orname,double *mpcon, ITG *nmpcon,ITG *nmpmat_,double*pphase,
          double *cphase,double *phaseother,ITG *nphase,ITG *phase_inf);
...
void dynacont(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	      ...
	      ITG *imastnode,ITG *nmastnode,double *xmastnor,
              ...
              double *prop,double *mpcon,ITG *nmpcon, ITG *nmpmat_);
...
void FORTRAN(invariant,(ITG *nk, double *stn, double *sinv, ITG *ncomp,
                        ITG *icomp));
...
void FORTRAN(mafilldm,(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       double *mpcon,ITG *nmpcon, ITG *nmpmat_));
...
void FORTRAN(mafilldmss,(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *nea,ITG *neb,
	       double *freq,ITG *ndamp,double *dacon,double *mpcon,
	       ITG *nmpcon, ITG *nmpmat_,double *rdpcon,double *gscon));
...
void FORTRAN(mafillem,(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *ielorien,ITG *norien,double *orab,ITG *ntmat_,
	       double *t0,double *t1,ITG *ithermal,
	       double *prestr,ITG *iprestr,double *vold,double *vini,
	       ITG *iperturb,double *sti,ITG *nzs,double *stx,
	       double *adb,double *aub,ITG *iexpl,
               double *plicon,ITG *nplicon,double *plkcon,ITG *nplkcon,
               double *xstiff,
	       ...
	       ITG *ielprop,double *prop,ITG *iponoel,ITG *inoel,
               ITG *network,double *mpcon,ITG *nmpcon, ITG *nmpmat_,
	       double *rdpcon,double *gscon));
...
void FORTRAN(mafillsm,(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *inoel,ITG *network,double *mpcon,ITG *nmpcon,
	       ITG *nmpmat_,double *rdpcon,double *gscon));
...
void FORTRAN(mafillsmcsse,(double *co,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *mcs,ITG *nk,ITG *nzss,double *mpcon,ITG *nmpcon,
	       ITG *nmpmat_));
...
void mafillsmmain(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       double *mpcon,ITG *nmpcon, ITG *nmpmat_,double *rdpcon,
	       double *gscon);

void mafillsmmain_h(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ITG *ne,ITG *nodeboun,ITG *ndirboun,double *xboun,
	       ITG *nboun,ITG *ipompc,ITG *nodempc,double *coefmpc,
	       ITG *nmpc,ITG *nodeforc,ITG *ndirforc,
	       double *xforc,ITG *nforc,ITG *nelemload,char *sideload,
	       ...
	       double *fnext,ITG *kscale,ITG *iponoel,ITG *inoel,
	       ITG *network,ITG *ntrans,ITG *inotr,double *trab,
	       double *mpcon,ITG *nmpcon, ITG *nmpmat_, ITG *ienthabased,
               double *flcon, ITG *nflcon, double *lh, double *enthaold,
               double *htcon, double *nhtcon, ITG *ipairmat);
...
void mafillsmmain_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *mcs,ITG *ieigenfrequency,double *mpcon,ITG *nmpcon,
	       ITG *nmpmat_);
...
void FORTRAN(mafillsmcsas,(double *co,ITG *nk,ITG *kon,ITG *ipkon,
	       ...
	       double *pslavsurf,double *pmastsurf,ITG *mortar,
               double *clearini,ITG *ielprop,double *prop,ITG *ne0,
               ITG *kscale,double *mpcon,ITG *nmpcon, ITG *nmpmat_));
...
void objectivemain_se(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     ITG *nodedesiinv,double *dgdxglob,double *df2,double *dgdxdy,
             ITG *nkon,double *mpcon,ITG *nmpcon,ITG *nmpmat_,double *rdpcon,
	     double *gscon);
...
void results(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     double *springarea,double *reltime,ITG *ne0,double *thicke,
             ...
             ITG *ibody,double *mpcon,ITG *nmpcon,ITG *nmpmat_,
             double *pphase,double *cphase,double *phaseother,
             ITG *nphase,ITG *phase_inf,double *rpdcon,double *gscon);

void results_h(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ITG *ne,double *v,double *stn,ITG *inum,
	     double *stx,
	     double *elcon,ITG *nelcon,double *rhcon,ITG *nrhcon,
	     double *alcon,ITG *nalcon,double *alzero,ITG *ielmat,
	     ...
	     double *springarea,double *reltime,ITG *ne0,double *thicke,
             ...
             ITG *ibody,double *mpcon,ITG *nmpcon,ITG *nmpmat_,
             double *pphase,double *cphase,double *phaseother,
             ITG *nphase,ITG *phase_inf,double *flcon,ITG *nflcon,
             double *htcon,ITG *nhtcon,double *srhocp,ITG *nsrhocp, double* lh,
             ITG *ienthabased,double *enthaold);
...
void FORTRAN(resultsmech,(double *co,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	  ...
	  ITG *kscale,ITG *list,ITG *ilist,double *mpcon,ITG *nmpcon,
	  ITG *nmpmat_,double *rdpcon,double *gscon));
...
void FORTRAN(resultsmech_se,(double *co,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
	  ...
	  double *dxstiff,ITG *ialdesi,double *xdesi,double *mpcon,
	  ITG *nmpcon, ITG *nmpmat_,double *rdpcon,double *gscon));
...
void FORTRAN(resultstherm,(double *co,ITG *kon,ITG *ipkon,
       ...
       double *xbodyact,ITG *ibody,double *mpcon,ITG *nmpcon, ITG *nmpmat_,
       double *pphase,double *cphase,double *phaseother,ITG *nphase,ITG *phase_inf,
       double *vini,double *gscon));

void *resultstherm_hmt(ITG *i);
...
void resultsinduction(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     ITG *iponoel,ITG *inoel,char *orname,ITG *network,
             ITG *ipobody,double *xbody,ITG *ibody,double *mpcon,
	     ITG *nmpcon, ITG *nmpmat_,double *pphase, double *cphase,
         double *phaseother,ITG *nphase,ITG *phase_inf);
...
void sensitivity(double *co,ITG *nk,ITG **konp,ITG **ipkonp,char **lakonp,
	     ...
	     char *orname,ITG *nzsfreq,ITG *nlabel,double *physcon,
             char *jobnamef,double *mpcon, ITG *nmpcon,ITG *nmpmat_,
	     double *rdpcon,double *gscon);
...
void solidification(double **co,ITG *nk,ITG **konp,ITG **ipkonp,char **lakonp,
	     ITG *ne,
	     ITG *nodeboun,ITG *ndirboun,double *xboun,ITG *nboun,
	     ITG **ipompcp,ITG **nodempcp,double **coefmpcp,char **labmpcp,
             ITG *nmpc,
	     ...
	     ITG *nmpmat_,double *pphase,double *cphase,double *phaseother,
             ITG *nphase,ITG *phase_inf,double *flcon,ITG *nflcon,
             double *lh, double *enthactrl, ITG *ipairmat);
...
void FORTRAN(springforc_n2f,(double *xl,ITG *konl,double *vl,ITG *imat,
	     ...
	     ITG *ielas,double *venergy,ITG *ielorien,double *orab,
             ITG *norien,ITG *nelem,double *mpcon,ITG *nmpcon, ITG *nmpmat_));
...
void steadystate(double **co,ITG *nk,ITG **kon,ITG **ipkon,char **lakon,ITG *ne,
	  ...
	  ITG *ndamp,double *dacon,double *mpcon, ITG *nmpcon,
	  ITG *nmpmat_,double *pphase,double *cphase,double *phaseother,
          ITG *nphase,ITG *phase_inf,double *rdpcon,double *gscon);
...
void stress_sen_2ndorder(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
       ...
       double *dgdxdy,double *mpcon, ITG *nmpcon,ITG *nmpmat_,double *rdpcon,
       double *gscon);
...
void stress_sen_dv(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
       ...
       ITG *idir,double *vold,double *dispmin,double *mpcon, ITG *nmpcon,
       ITG *nmpmat_,double *rdpcon,double *gscon);
...
void stress_sen_dx(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,ITG *ne,
       ...
       double *mpcon, ITG *nmpcon,ITG *nmpmat_,double *rdpcon,double *gscon);
...
void FORTRAN(phaselatentheat,(double *shcon,ITG *nshcon,double *rhcon,
            ITG *nrhcon,double *v,double *vold,double *vini,ITG *nk,
            ITG *ne,char *lakon,double *xstateini,double *xstate,ITG *nstate_,
            ITG *mi,ITG *ipkon,ITG *kon,ITG *ntmat_,double *cphase,ITG *phase_inf,
            ITG *nphase,ITG *iout));

void FORTRAN(phaseini,(double *xstate,ITG *nstate_,ITG *mi,ITG *ne,char *lakon,
            double *cphase,ITG *phase_inf,ITG *nphase));
 ...
 */
typedef enum {
  //! interface to standard WeICME behaviours
  WeICME_STANDARD_INTERFACE,
  //! interface to abaqus behaviours in small strain
  WeICME_ABAQUS_INTERFACE,
  //! interface to abaqus behaviours in finite strain
  WeICME_ABAQUSNL_INTERFACE
} WeICMEInterface;
/*!
...
typedef struct
{
  ...
  // function pointer
  const void* ptr;
}  WeICMEExternalBehaviour;
/*!
 * \return the description of an external beahviour
 * \param[in] n : external behaviour name
 */
const WeICMEExternalBehaviour*
WeICME_searchExternalBehaviour(const char*);
/*!
 * \param[in] n: material name
 */
void WeICME_registerExternalBehaviour(const char *);
/*!
 * \brief free the memory associated with external behaviours
 * treatment.
 */
void WeICME_freeExternalBehaviours();
