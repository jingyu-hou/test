...
!
! File name = vtkVISXYPlotWin32Header.h
!
! Version: ASTE-P 2.0
!
! Time of release: 
...
#ifndef __vtkVISXYPlotWin32Header_h
#define __vtkVISXYPlotWin32Header_h

#include <vtkVISConfigure.h>

#if defined(WIN32) && !defined(VTKVIS_STATIC)
#if defined(vtkVISXYPlot_EXPORTS)
#define VTK_VIS_XYPLOT_EXPORT __declspec( dllexport ) 
#else
#define VTK_VIS_XYPLOT_EXPORT __declspec( dllimport ) 
#endif
#else
#define VTK_VIS_XYPLOT_EXPORT
#endif
