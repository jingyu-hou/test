...
!
! File name = vtkVISUnstructuredGridWin32Header.h
!
! Version: ASTE-P 2.0
!
! Time of release: 
...
#ifndef __vtkVISUnstructuredGridWin32Header_h
#define __vtkVISUnstructuredGridWin32Header_h

#include <vtkVISConfigure.h>

#if defined(WIN32) && !defined(VTKVIS_STATIC)
#if defined(vtkVISUnstructuredGrid_EXPORTS)
#define VTK_VIS_UNSTRUCTUREDGRID_EXPORT __declspec( dllexport ) 
#else
#define VTK_VIS_UNSTRUCTUREDGRID_EXPORT __declspec( dllimport ) 
#endif
#else
#define VTK_VIS_UNSTRUCTUREDGRID_EXPORT
#endif
