...
public:
    ...
    //qy add enum of toolbutton
    enum RibbonButtonPopMode{
        DelayedPopup,
        MenuButtonPopup,
        InstantPopup,
        MyDefine1Popup
    };
    SARibbonToolButton(QWidget *parent = NULL);//qy Q_NULLPTR);
    SARibbonToolButton(QAction* defaultAction,QWidget *parent = NULL);//qy Q_NULLPTR);
