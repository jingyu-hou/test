    ...
    : QDialog(parent)
{
    ...
    m_NewSectionBtn = new QPushButton(tr("����"));
    m_DelSectionBtn = new QPushButton(tr("ɾ��"));
	m_ImprotPart=new QPushButton(tr("���벿��"));
    m_ApplaySectionBtn = new QPushButton(tr("Ӧ��"));
    m_NextSectionBtn = new QPushButton(tr("��һ��"));
    Hlayout1->addStretch();
	...
	QGroupBox *GBox=new QGroupBox(tr("����ģ��ѡ��"),this);
	m_Tab1=new QWidget();
	D3Model=new QRadioButton(tr("3D"));
	AxialSymmetry=new QRadioButton(tr("��Գ�"));
	PlaneStress=new QRadioButton(tr("ƽ��Ӧ��"));
	PlaneStrain=new QRadioButton(tr("ƽ��Ӧ��"));
	//Default0=new QRadioButton(tr("��Inp�ļ���Ԫ����һ��"));
    ...
    {
		/*QPushButton* m_ImprotPart = new QPushButton(tr("����"));
...
void QHPPartDlg::SetInpData(ReadInpResultS ReadInpData)
{
    ...
    //--���ݵ�ǰSection ����ѡ���Material���������õ�ǰcombox1��index��
    ...
    writeUnitPSetToInp(ReadInpData);//��Inp�ж�ȡ���Ľڵ㡢��Ԫ�����ϵ�д�뵽��ǰ��INP��
    WritePartDataToInp();
}
...
void QHPPartDlg::ShowPartDlgStyle(int style)
{
	...
	if (style == 0){//���� ;
	...
	}else if (style == 1){//�ȵȾ�ѹ ;
		m_TableWiget->setColumnHidden(1,true);
		m_TableWiget->setColumnHidden(2,false);
		m_TableWiget->setColumnHidden(3,false);
		m_TableWiget->setColumnHidden(4,true);
		if (nRow == 1){
			m_TableWiget->item(0,0)->setText(tr("����"));
			m_TableWiget->setRowHidden(0,false);
		}else if (nRow ==2){
			m_TableWiget->item(0,0)->setText(tr("����"));
			m_TableWiget->item(1,0)->setText(tr("������ĩ"));
			m_TableWiget->setRowHidden(0,false);
			m_TableWiget->setRowHidden(1,false);
		} else if (nRow ==3){
			m_TableWiget->item(0,0)->setText(tr("����"));
		...
		m_TableWiget->setColumnHidden(4,true);
		if (nRow == 1){
			m_TableWiget->item(0,0)->setText(tr("ģ��1"));
			m_TableWiget->setRowHidden(0,false);
		}else if (nRow ==2){
			m_TableWiget->item(0,0)->setText(tr("ģ��1"));
			m_TableWiget->item(1,0)->setText(tr("�����"));
			m_TableWiget->setRowHidden(0,false);
			m_TableWiget->setRowHidden(1,false);
		}else if (nRow ==3){
			m_TableWiget->item(0,0)->setText(tr("ģ��1"));
			m_TableWiget->item(1,0)->setText(tr("�����"));
			m_TableWiget->item(2,0)->setText(tr("ģ��2"));
			m_TableWiget->setRowHidden(0,false);
			m_TableWiget->setRowHidden(1,false);
...
{ 
	...
	QStringList MaterList;
    if( m_SectionManageDlg->BtnCreateSlot())//section�����ɹ������Table����ʾ
    {
...
void QHPPartDlg::comBoxMChgSlot()
{
    ...
    if (strIdName.toLower() == "�½�")
    {
        if(m_MaterManagerDlg->BtnCreateSlot()){
            ...
            if(curretIndex!=-1){//��ʾ�ڵ�ǰtabwiget��
...
void QHPPartDlg::WritePartDataToInp()
{
    ...
    for(int i=0; i<TabRowCnt; i++){
        ...
        if(nodeSList.StrMaterial!="�½�")m_nodeSList.append(nodeSList);
    }
    ...
    if (!m_nodeMList.size()){
        ...
        if(nodeMList.strMaterialName!="�½�")m_nodeMList.append(nodeMList);
    }
}
...
{
	QRadioButton *RBtn=qobject_cast<QRadioButton*>(sender());//��ȡ�����źŵĵ�ѡ��
